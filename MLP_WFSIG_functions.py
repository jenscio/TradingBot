...
# %%
sys.path.append(str(pathlib.Path(__file__).resolve().parents[1]))  # adds TradingBot to path
...
full_df = load_data(csv_path, start='2014-12-17', end_excl='2025-07-17')

# Define periods
df_train = full_df.loc['2014-12-17':'2022-01-01']
df_test = full_df.loc['2022-01-02':'2025-07-17']
